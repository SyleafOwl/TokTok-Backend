...
CREATE TABLE "AudienceMetrics" (
    ...
    CONSTRAINT "AudienceMetrics_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "AudienceMetrics_userId_key" ON "AudienceMetrics"("userId");

-- CreateIndex
CREATE INDEX "AudienceMetrics_userId_idx" ON "AudienceMetrics"("userId");
...
-- AddForeignKey
ALTER TABLE "AudienceMetrics" ADD CONSTRAINT "AudienceMetrics_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
